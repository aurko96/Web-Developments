...
<body id="different">
	...
	<section id="secbar">
		...
		<ul>
			...
			<li>
				<form action="http://localhost/openshop/view/buy.php" method="POST">

				<button class="button2" type="submit" value="<?php echo htmlspecialchars($pro_id); ?>" name="buyButton">Buy
				</button>

				</form>
			</li>

			<li><form action="http://localhost/openshop/controller/editCart.php" method="POST"><button class="button2" type="submit" value="<?php echo htmlspecialchars($pro_name); ?>" name="cartButton">Delete From Favourites </button></li>
