...
<body id="different">
	...
	<section id="secbar">
		...
		<ul>
			...
			<li>
				<form action="http://localhost/openshop/controller/editProduct.php" method="POST">
			...
			<li>
				<button class="button2" type="submit" value="add" name="addButton">ADD</button>

				<button class="button2" type="submit" value="delete" name="deleteButton">DELETE</button>
			</form>
