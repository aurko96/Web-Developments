	...
	<nav id="navbar">
		<div class="container">
			<ul>
				...
				<li><a href="myCart.php"><u>My Favourites</u></a></li>
			</ul>
		</div>
	</nav>
	<section >
		<div class="container">
			...
			<?php
				...
				$host =  'localhost';
			  	...
			  	$sql='SELECT * from products where product_quantity>0 and product_id in (SELECT product_id from product_cart where user_name like ?)';
			  	...
			  	if($count){
			  		while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
	                    ...
	                    echo "<form action='http://localhost/openshop/view/myCartDetail.php' method='POST'><input type='image' src='../view/images/".$row['product_image']."' height='200' width='200' value='".$row['product_id']."' name='product_detail'></form>";
